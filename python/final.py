...
class colourIdentifier():
	...
	def __init__(self):
		...
		self.hsv_lower_blue = np.array([120 - self.blue_sensitivity, 100, 100])
		self.hsv_upper_blue = np.array([120 + self.blue_sensitivity, 255, 255])

		# Red upper and lower bound
		self.hsv_lower_red = np.array([0 - self.red_sensitivity, 100, 100])
		self.hsv_upper_red = np.array([0 + self.red_sensitivity, 255, 255])
